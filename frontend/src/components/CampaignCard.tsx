...
const CampaignCard = ({
    ...
    return (
        <div className="group glass-card overflow-hidden rounded-[2.5rem] flex flex-col hover:-translate-y-2 hover:premium-shadow transition-all duration-500">
            ...
            <div className="px-6 py-6 flex-grow flex flex-col justify-between">
